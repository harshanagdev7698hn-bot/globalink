...
const products = [
  {
    name: "ISI Mark Industrial Helmet",
  ...
  {
    name: "Certified Lab Equipment Kit",
    category: "Lab Equipment",
    seller: "Global Lab Supply",
    certification: "ISO / NABL Ready",
    price: "₹18,500 onwards",
  },
  {
    name: "EPR Compliance Packaging Material",
    category: "Packaging",
    seller: "Eco Compliance Seller",
    certification: "EPR Supported",
    price: "₹12/kg onwards",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-5 py-10">
        <section className="rounded-[34px] bg-[#000F22] px-8 py-14 text-white shadow-xl md:px-14">
          ...
          <h1 className="mt-6 max-w-4xl text-4xl font-extrabold leading-tight md:text-6xl">
            Discover certified products, equipment and trusted sellers
          </h1>

          <p className="mt-6 max-w-3xl text-base leading-8 text-[#DCEBFA]">
            Explore compliance-ready products, lab equipment and certified
            industrial solutions from verified sellers.
          </p>
        </section>
        ...
        <section className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {products.map((product) => (
            ...
            >
              ...
              <p className="mt-6 text-sm font-bold uppercase tracking-[0.25em] text-[#5B86B6]">
                {product.category}
              </p>

              <h2 className="mt-3 text-2xl font-black text-[#000F22]">
                {product.name}
              </h2>

              <div className="mt-5 grid grid-cols-2 gap-3">
                <Info label="Seller" value={product.seller} />
                <Info label="Certification" value={product.certification} />
              </div>

              <p className="mt-6 text-2xl font-black text-[#1B3554]">
                {product.price}
              </p>
